...
function Thinking() {
  const notes = [
    { n: '014', date: '17 May 2026', cat: 'Operating', title: 'The best growth teams ship faster than they strategize.', dek: 'Three observations from a year of embedded engagements — and what makes the high-leverage teams different.' },
    { n: '013', date: '02 May 2026', cat: 'Tracking', title: 'You don\'t have a data problem. You have a definitions problem.', dek: 'Why "active user" means seven different things across your tools — and how to fix it in one afternoon.' },
    { n: '012', date: '18 Apr 2026', cat: 'Paid', title: 'Server-side conversion APIs aren\'t optional any more.', dek: 'iOS attrition, browser deprecations, and the four hours of work that recovers 30% of your signal.' },
    { n: '011', date: '04 Apr 2026', cat: 'CRO', title: 'The five experiments every B2B onboarding should run.', dek: 'A field-tested playbook — what to test, in what order, and the win rates I\'ve seen across 12 portfolios.' },
  ];
  return (
    <SectionWrap id="thinking" bg={T.paper}>
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 50, gap: 40, flexWrap: 'wrap' }}>
        ...
        <p style={{ fontFamily: T.body, fontSize: 16, lineHeight: 1.6, color: T.softInk, margin: 0, maxWidth: 380 }}>
          A handful of operating principles, post-mortems, and playbooks I share publicly. New piece every fortnight.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 80, alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18, paddingTop: 60 }}>
          <p style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 28, lineHeight: 1.4, margin: 0 }}>
            Operator first, agency last.
          </p>
          <p style={{ fontFamily: T.body, fontSize: 17, lineHeight: 1.65, color: T.softInk, margin: 0 }}>
            I've spent seven years running growth inside venture-backed companies — most recently as Head of Growth at a Series B fintech, before that as the third employee at a B2B SaaS that exited in 2023.
          </p>
          <p style={{ fontFamily: T.body, fontSize: 17, lineHeight: 1.65, color: T.softInk, margin: 0 }}>
            CGE is what I do now. One client at a time, ninety days at a time. The work is the same things I did in-house — paid acquisition, the analytics layer, conversion engineering, the lifecycle automation — except the deliverable is a system your team can run when I'm gone.
          </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18, marginTop: 18 }}>
            {[
              ...
              ['Working hours', 'GMT+2 · flexible to US/EU'],
              ['Engagements', 'Audits, builds, programmes — mixed'],
...
function Testimonials() {
  const quotes = [
    { q: 'Rob shipped more in 90 days than my previous agency did in a year. The handover docs alone were worth the engagement.', a: 'Sarah Chen', t: 'VP Growth · Northstar Labs' },
    { q: 'Treats growth like engineering. We had real instrumentation, real experiments, and real defensible numbers by week four.', a: 'Marcus Vega', t: 'Founder · Helix Capital' },
    { q: 'Came in as one person and walked out leaving a system three of my team now run. That\'s the rare bit.', a: 'Priya Mehta', t: 'CEO · Atlas Robotics' },
  ];
  return (
    <SectionWrap bg={T.paper}>
      <SectionLabel>§ 08 — What founders say</SectionLabel>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24, marginTop: 32 }}>
        {quotes.map((q, i) => (
          <div key={i} style={{ display: 'flex', flexDirection: 'column', gap: 18, padding: 30, background: T.cream, position: 'relative' }}>
            <div style={{ position: 'absolute', top: 18, right: 18 }}>
              <Bracket size={20} color={T.accent} weight={2.5} spaceRatio={.4} side="r" />
            </div>
            <p style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 21, lineHeight: 1.4, margin: 0, paddingTop: 22 }}>
              "{q.q}"
            </p>
            <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 4 }}>
              <Rule color={T.ink} opacity={.15} style={{ marginBottom: 10 }} />
              <div style={{ fontFamily: T.display, fontWeight: 900, fontSize: 14, letterSpacing: '-.01em', textTransform: 'uppercase' }}>
                {q.a}
              </div>
              <div style={{ fontFamily: T.mono, fontSize: 10, letterSpacing: '.18em', textTransform: 'uppercase', opacity: .65 }}>
                {q.t}
              </div>
            </div>
          </div>
...
function Pricing() {
  const tiers = [
    ...
    },
    {
      ...
      best: 'Best for: scaling spend past $50k/mo',
...
function FAQ() {
  const qs = [
    { q: 'Are you actually one person?', a: 'Yes. I take a small number of concurrent engagements — typically 2–3, weighted by intensity — and run every part personally. For specialist work (long-form copy, animation, brand) I pull in 3–4 trusted collaborators on a per-project basis. You\'ll always know who you\'re working with.' },
    ...
    { q: 'Do you take equity instead of cash?', a: 'For a small number of selective engagements per year, yes. I look for founders building category-defining things in markets I understand. Reach out if that\'s you.' },
    { q: 'What stage do you typically work with?', a: 'Series A through C. Earlier than that, founders are usually better served by hands-on tools and a tight team. Later, you need a team, not me. Sweet spot: $2M–$50M ARR, 10–50 people.' },
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr', gap: 40, paddingBottom: 60, borderBottom: `1px solid rgba(255,255,255,.15)` }}>
          <div>
            ...
            <p style={{ fontFamily: T.body, fontSize: 14, lineHeight: 1.6, color: 'rgba(255,255,255,.7)', marginTop: 18, maxWidth: 360 }}>
              A working studio for compounding growth. Operated solo from Cape Town, working with founders worldwide.
            </p>
          ...
          {[
            ...
            { h: 'Contact', items: ['rob@chiefgrowthengineer.com', '+27 66 212 7955', 'Cape Town · GMT+2', 'LinkedIn · @roblouw', 'X · @cge_group'] },
          ].map(col => (
            <div key={col.h}>
...
Object.assign(window, { Thinking, About, Testimonials, Pricing, FAQ, BigCTA, Footer });
